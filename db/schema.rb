...
ActiveRecord::Schema.define(version: 20170421162528) do
  ...
  create_table "cvs", force: :cascade do |t|
    ...
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
    t.index ["published_at"], name: "index_cvs_on_published_at", using: :btree
    t.index ["status"], name: "index_cvs_on_status", using: :btree
    t.index ["user_id"], name: "index_cvs_on_user_id", using: :btree
    t.index ["username"], name: "index_cvs_on_username", using: :btree
  end
